        ...
        <div className="container-custom">
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <span className="flex h-8 w-8 items-center justify-center rounded-md bg-foreground text-background group-hover:bg-accent transition-colors">
          ...
          >
            <div className="flex items-center justify-between p-4 border-b">
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading text-lg font-bold tracking-[0.15em]">VOLTA</span>
              </div>
              <button
